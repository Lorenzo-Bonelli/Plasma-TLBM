...
# Run the script: ./valgrind__complete.sh [number_of_cores]
...
# Run under Valgrind with detailed leak check
echo "Compilation successful. Launching simulation under Valgrind..."
...
echo "Valgrind analysis complete. See valgrind_output.log for details."
