...
int main(int argc, char* argv[]) {
    ...
    size_t NX = 1000;           // Number of nodes in the x-direction
    size_t NY = NX;           // Number of nodes in the y-direction
    const double u_lid = 0.3;            // Lid velocity at the top boundary
